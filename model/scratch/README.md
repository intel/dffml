...
$ dffml accuracy -model scratchslr -model-features Years:int:1 -model-predict Salary -model-location tempdir -features Salary -sources f=csv -source-filename dataset.csv -source-readonly -log debug
1.0
