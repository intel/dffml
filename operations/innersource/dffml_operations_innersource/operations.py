...
async def ensure_java(
    ...
    *,
    ...
    # TODO Take as args
    java = await dffml.cached_download_unpack_archive(
        "https://download.java.net/java/GA/jdk19.0.1/afdd2e245b014143b62ccb916125e3ce/10/GPL/openjdk-19.0.1_linux-x64_bin.tar.gz",
        cache_dir.joinpath("java.tar.gz"),
        cache_dir.joinpath("java-download"),
        "ec79c3f085c295876f96d38bfaece0c565ff89152928d71a8b6bf1baf9eda2f27ce6cd857612a4e73540e67c1c0229b5",
    )
    # Find the binary
    java_bin_path = [
        path.parent
