...
graph TD
    ...
    subgraph alice_forge
      alice_heartwood_httpd[Alice: Heartwood HTTPD]
      alice_heartwood_node[Alice: Heartwood Node]
      ...
      alice_online_clone_hook_scitt_changes -->|execution of running of CI/CD job via issue ops as manifest| alice_heartwood_node
    end
